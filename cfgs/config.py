...
__C.TRAIN.lr_base = 1e-4

# __C.TRAIN.penalty_rate = 1e-8
__C.TRAIN.penalty_rate = 0
...
def proc(config):
    assert config.run_mode in ['train', 'val', 'test', 'sample']
    ...
    # config.n_gpu = 1
    # config.device = "cuda:1" if config.n_gpu else "cpu"
